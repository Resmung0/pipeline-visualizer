...
class PipelineTransformer(Transformer):
    ...
    def pipe(self, left: Node, right: Node) -> Pipeline:
        """Create a pipeline node for the pipe operator.

        Args:
            left (Node): The left stage or pipeline.
            right (Node): The right stage or pipeline.
    ...
    def logical_and(self, left: Node, right: Node) -> Pipeline:
    ...
    def logical_or(self, left: Node, right: Node) -> Pipeline:
    ...
    def semmicolon(self, left: Node, right: Node) -> Pipeline:
    ...
    def redirect_out(self, left: Node, right: Node) -> Pipeline:
    ...
    def redirect_out_append(self, left: Node, right: Node) -> Pipeline:
    ...
    def redirect_in(self, left: Node, right: Node) -> Pipeline:
    ...
    def redirect_in_append(self, left: Node, right: Node) -> Pipeline:
