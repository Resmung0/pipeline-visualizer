...
from pipeline_visualizer.renders import (
    badge_render,
    standard_render,
    step_render,
    tree_render,
...
def pipeline(
    ...
    *,
    ...
    layout: Literal["panel", "tree", "badge", "step"] = "panel",
    ...
    Args:
        ...
        layout (Literal["panel", "tree", "badge", "step"]): Layout style of the visualization. Defaults to "panel".
    ...
    match layout:
        ...
        case "step":
            step_render.render(parsed_pipeline)
